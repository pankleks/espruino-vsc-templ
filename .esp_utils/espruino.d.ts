...
*/
declare function analogWrite(pin: Pin | number, value: number, options: any): void;
...
*/
declare function digitalWrite(pin: Pin | number, value: number | boolean): void;
...
*/
declare function digitalRead(pin: Pin | number): number;
...
*/
declare function pinMode(pin: Pin | number, mode: any, automatic?: boolean): void;
...
*/
declare function setWatch(f: (a?: any) => any, pin: Pin | number, options: any): any;
